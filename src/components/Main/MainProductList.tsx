...
const productsList = [
  ...
  } as IProduct,
  {
    ...
    imgSrc: "/main-carts/angel-wing-begonia.webp",
    price: 169,
    size: "large",
    categories: "seeds",
    discount: {
  ...
  } as IProduct,
  {
    ...
    imgSrc: "/main-carts/african-violet.webp",
    price: 229,
    size: "large",
  ...
  } as IProduct,
  {
    ...
    imgSrc: "/main-carts/aluminum-plant.webp",
    price: 129,
    size: "large",
    categories: "seeds",
    discount: {
  ...
  } as IProduct,
  {
    ...
    imgSrc: "/main-carts/blushing-bromeliad.webp",
    price: 139,
    size: "medium",
    categories: "House Plants",
    discount: {
  ...
  } as IProduct,
  {
    ...
    imgSrc: "/main-carts/birds-nest-fern.webp",
    price: 99,
    size: "small",
    categories: "Small Plants",
    discount: {
  ...
  } as IProduct,
  {
    ...
    imgSrc: "/main-carts/broadleaf-lady-palm.webp",
    price: 59,
    size: "small",
    categories: "Small Plants",
    discount: {
  ...
  } as IProduct,
  {
    ...
    imgSrc: "/main-carts/chinese-evergreen.webp",
    price: 39,
    size: "small",
    categories: "Small Plants",
    discount: {
  ...
  const cartList = productsList.map((el: IProduct) => {
    ...
    return (
      <div
        ...
        className="main-content__card-item"
        key={el.id}
      >
        <div className="card-item__img-container">
          <div
            className="card-item__img-item"
            style={{
              background: `url(${el.imgSrc}), lightgray 50% / cover no-repeat`,
            }}
          ></div>
        </div>
